  ...
  static List<GameLocation> getAllLocations() {
    return [
      ...
      const GameLocation(
        ...
        isVisited: true,
        reputation: 50,
        connectedLocations: ['piraeus', 'marathon', 'eleusis', 'aegina'],
      ),
      ...
      const GameLocation(
        id: 'piraeus',
        name: 'Piraeus',
        description: 'The great harbor of Athens, bustling with merchants from across the Mediterranean.',
        type: LocationType.port,
        latitude: 37.9420,
        longitude: 23.6463,
        region: 'Attica',
        specialties: ['Shipping', 'International Trade', 'Naval'],
        availableServices: ['Harbor', 'Market', 'Shipyard'],
        isUnlocked: true,
        reputation: 25,
        connectedLocations: ['athens', 'aegina', 'salamis'],
      ),
