...
class SpartaScreen extends ConsumerStatefulWidget {
  const SpartaScreen({super.key});

  @override
  ConsumerState<SpartaScreen> createState() => _SpartaScreenState();
}

class _SpartaScreenState extends ConsumerState<SpartaScreen> {
  @override
  void initState() {
    super.initState();
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'The legendary warrior city-state. Home of the most feared soldiers in Greece.',
                            style: TextStyle(
                              fontSize: 14,
